package
{
	...
	public class YouSayJumpPreloader extends FlxPreloader {
		...
		public function YouSayJumpPreloader() {			
			className = "YouSayJumpISayHowHigh";
			super();
		}
		...
		override protected function create():void {
			...
			_bg = new Bitmap(new BitmapData(800,640,false,0xCCDDEE));
			_bg.x = 0; _bg.y = 0;
